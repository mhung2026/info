...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Page Title -->
        <title>Hung Ngo Minh - Personal Portfolio</title>
        <!-- Favicon Icon -->
                ...
                <div class="container">
                    <div class="st-main-header-in">
                        <div class="st-main-header-left">
                            <div class="st-header-author">
                                <img
                                    src="assets/img/section/hero-img.jpg"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div class="st-main-header-right">
                            <div class="st-nav">
                                ...
                                <div class="st-hero-btn">
                                    <a
                                        href="#contact"
                                        class="st-btn st-style2 st-color1 st-btn-md st-smooth-move"
                                        >Hire me</a
                                    >
                                </div>
                            </div>
        ...
        <section class="st-hero st-style2">
            <div class="container">
                <div class="st-hero-text">
                    <h1>Hi, I am <span>Hung Ngo Minh</span></h1>
                    <p>
                        I am a full-stack web developer, capable of both backend
                        and frontend development. <br />I create clean,
                        maintainable code and ensure seamless integration
                        between frontend designs and backend functionality. I
                        also enhance user experiences with interactive web
                        animations. I can provide clean code and pixel perfect
                        design.
                    </p>
                    <div class="st-hero-social-links">
                        <a
                            href="https://www.facebook.com/hung2026/"
                            class="st-social-btn"
                        >
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a
                            href="https://www.linkedin.com/in/hung2026/"
                            class="st-social-btn"
                        >
                            <i class="fab fa-linkedin"></i>
                        </a>
                        <a
                            href="https://github.com/mhung2026/"
                            class="st-social-btn"
                        >
                            ...
                            <div class="st-vertical-middle-in">
                                <div class="st-text-block st-style1">
                                    <h2 class="st-text-block-title">
                                        Hi There! I'm Hung Ngo Minh
                                    </h2>
                                    <h4 class="st-text-block-subtitle">
                                        Full-stack web developer
                                    </h4>
                                    <div class="st-text-block-text">
                                        <p>
                                            I am a full-stack web developer with
                                            a strong focus on digital branding.
                                            I combine both frontend and backend
                                            expertise to create seamless,
                                            interactive experiences that
                                            attract, inspire, and motivate
                                            users. My approach integrates clean
                                            code with visually appealing designs
                                            to deliver a lasting impact and
                                    ...
                                    <ul class="st-text-block-details st-mp0">
                                        <li>
                                            <span>Birthday</span> :
                                            <span>Sep 26, 2002</span>
                                        </li>
                                        <li>
                                            <span>Phone</span> :
                                            <span>+84 825-613-369</span>
                                        </li>
                                        <li>
                                            <span>Email</span> :
                                            <span
                                                >ngominhhung208@gmail.com</span
                                            >
                                        </li>
                                        <li>
                                            <span>From</span> :
                                            <span
                                                >VinHomes Grand Park, District
                                                9, Ho Chi Minh</span
                                            >
                                        </li>
                                        <li>
                        ...
                        <div class="st-iconbox st-style1">
                            <div class="st-iconbox-icon">
                                <svg viewBox="0 0 512 512">
                                    <g>
                                        <path
                                            d="m336 144a8 8 0 0 0 -8 8v104a8 8 0 0 0 16 0v-104a8 8 0 0 0 -8-8z"
                                        />
                                        <path
                                            d="m336 272a8 8 0 0 0 -8 8v8a8 8 0 0 0 16 0v-8a8 8 0 0 0 -8-8z"
                                        />
                                        <path
                                        ...
                                        />
                                        <path
                                            d="m48 72h72a8 8 0 0 0 0-16h-72a8 8 0 0 0 0 16z"
                                        />
                                        <path
                                            d="m80 88a8 8 0 0 0 -8-8h-24a8 8 0 0 0 0 16h24a8 8 0 0 0 8-8z"
                                        />
                                        <path
                            ...
                            <div class="st-iconbox-text">
                                Lorem ipsum dolor sittem ametamn elit, per sed
                                do eiusmoad teimpor sittem elit inuning utsed
                                sittem.
                            </div>
                        </div>
                        ...
                        <div class="st-iconbox st-style1">
                            <div class="st-iconbox-icon">
                                <svg viewBox="0 0 512 512">
                                    <g>
                                        <path
                                            d="M216,456H160a8,8,0,0,0,0,16h56a8,8,0,0,0,0-16Z"
                                        />
                                        <path
                                            d="M248,456h-8a8,8,0,0,0,0,16h8a8,8,0,0,0,0-16Z"
                                        />
                                        <path
                        ...
                        <div class="st-skill-wrap">
                            <div class="st-skill-heading">
                                <h2 class="st-skill-title">
                                    All the skills that I have in that field of
                                    work are mentioned.
                                </h2>
                                <div class="st-skill-subtitle">
                                    ...
                                    <br /><br />Stet clita kasd gubergren, no
                        ...
                        <div class="st-progressbar-wrap">
                            <div class="st-single-progressbar">
                                ...
                                <div class="st-progressbar" data-progress="95">
                                    <div
                                        class="st-progressbar-in wow fadeInLeft"
                                    ></div>
                                </div>
                            </div>
                            ...
                            <div class="st-single-progressbar">
                                <div class="st-progressbar-heading">
                                    <h3 class="st-progressbar-title">NestJS</h3>
                                    <div
                                        class="st-progressbar-percentage wow fadeInLeft"
                                        data-wow-duration="1.5s"
                                        data-wow-delay="0.5s"
                        ...
                        <div class="st-resume-wrap">
                            <div class="st-resume-heading">
                                <img
                                    ...
                                    alt="resume-icon"
                                />
                                <h2 class="st-resume-heading-title">
                                    Experience
                                </h2>
                            </div>
                                ...
                                <div class="st-resume-timeline">
                                    ...
                                    <div class="st-resume-timeline-text">
                                        <p>
                                            ...
                                            ligula nulla, tincidunt id faucibus
                                            sed, suscipit feugiat turpis.
                                        </p>
                                    </div>
                                </div>
                                <!-- st-resume-timeline -->
                                <div
                                    class="st-height-b50 st-height-lg-b30"
                                ></div>
                                <div class="st-resume-timeline">
                                    <h3 class="st-resume-timeline-title">
                                        Business Analysis
                                    ...
                                    <h4 class="st-resume-timeline-subtitle">
                                        NINA Trading And Services Co., Ltd
                                    </h4>
                                    <div class="st-resume-timeline-text">
                                        <p>
                                            Lorem ipsum dolor sit amet,
        ...
        <section id="portfolio">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div
                            class="st-portfolio-single st-style1 st-lightgallery"
                        >
                            ...
                            <div class="slick-slide-in">
                                ...
                                >
                                    <div class="st-testimonial-text">
                                        <p>
                                            “Lorem ipsum dolor sittem
                                            ametamngcing elit, per sed do
                                            eiusmoad teimpor sittem elit inuning
                                            utsed sittem do eiusmod.”
                                        </p>
                                        <div class="st-quote">
                                            <img
                                    ...
                                    <div class="st-testimonial-info">
                                        ...
                                        <div class="st-testimonial-meta">
                                            <h4 class="st-testimonial-name">
                                                Richard Miles
                                            </h4>
                                            <div
                                                class="st-testimonial-designation"
                                            >
                                                Chairman
                                            </div>
                                        </div>
                                    ...
                                    <div class="st-post-info">
                                        <div class="st-post-date">
                                            ...
                                            <a href="#" class="st-post-author"
                                                >Admin</a
                                            >
                                            <span class="st-post-date-divider"
                                                >|</span
                                            >
                                            <span class="st-post-publish-date"
                                                >27-09-2020</span
                                            >
                                        </div>
                            ...
                            <div class="slick-slide-in">
                                <div class="st-post-single st-style1">
                                    ...
                                    <div class="st-post-info">
                                        ...
                                        <h4 class="st-post-title">
                                            <a href="blog-details.html"
                                                >Were there any mistakes you’ve
                                                made as a designer</a
                                            >
                                        </h4>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="st-contact-text">
                            ...
                            elit. Nunc ligula nulla tincidunt id faucibus sed
                            suscipit feugiat. -->
                        </div>
                        <div class="st-contact-info-wrap">
                            <div class="st-single-contact-info">
                                ...
                                <div class="st-single-info-details">
                                    <h4>Email</h4>
                                    <a href="#">ngominhhung208@gmail.com</a>
                            ...
                            <div class="st-single-contact-info">
                                ...
                                <div class="st-single-info-details">
                                    <h4>Address</h4>
                                    <span
                                        >VinHomes Grand Park, District 9, Ho Chi
                                        Minh</span
                                    >
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="st-copyright-wrap text-center">
                    <div class="st-copyright-text">
                        © 2024. Designed by Hung Ngo Minh. All right reserved.
                    </div>
                </div>
            </div>
        </footer>
